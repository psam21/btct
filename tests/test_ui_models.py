"""
Clean unit tests for UI data models and functionality.

Tests the core data structures used by UI components.
"""
...
class TestUIPerformance:
    ...
    def test_large_dataset_display_limit(self):
        ...
        large_candles = []
        for i in range(1000):  # 1k candles (reasonable for testing)
            candle = Candlestick(
                timestamp=datetime(2024, 1, 1),
                open_price=Decimal("45000.00"),
                high_price=Decimal("45500.00"),
    ...
    def test_data_processing_efficiency(self):
        ...
        # Processing should be reasonably fast (less than 0.1 second for 100 items)
